...
public class Metyloformyloamid
{
    public static ItemStack getItem()
    {
        ...
        lore.add(ColorUtil.formatHEX(" &8> &7Nazwa: &fMetyloformyloamid"));
        ...
        meta.setDisplayName(ChatColor.translateAlternateColorCodes('&', "&fMetyloformyloamid"));
        meta.setLore(lore);
    ...
    {
        NamespacedKey key = new NamespacedKey(Main.getInstance(), "metyloformyloamid_crafting");
        ShapedRecipe recipe = new ShapedRecipe(key, getItem());

        recipe.shape("AMA", "MXM", "AMA");
        recipe.setIngredient('X', new RecipeChoice.ExactChoice(Fenyloaceton.getItem()));
        recipe.setIngredient('M', new RecipeChoice.ExactChoice(Metyloamina.getItem()));
