...
public class Monster3
{
    public static ItemStack getItem()
    {
        ...
        potion.setColor(Color.fromRGB(222, 180, 203));
        ...
        lore.add(ColorUtil.formatHEX(" &8> &7Nazwa: &fMonster Ultra Violet"));
        lore.add(ColorUtil.formatHEX(" &8> &7Klasyfikacja: &fStymulanty"));
        lore.add(ColorUtil.formatHEX(" &8> &7Zawartosc kofeiny: &f160mg"));
        lore.add(ColorUtil.formatHEX(" &8> &7Rodzina substancji: &fN/A"));
        lore.add(ColorUtil.formatHEX(""));
        lore.add(ColorUtil.formatHEX("   &e&o(Ciekawostka: Monster ten to"));
        lore.add(ColorUtil.formatHEX("   &e&oedycja specjalnie dla tych"));
        lore.add(ColorUtil.formatHEX("   &e&owyluzowanych)"));
        lore.add(ColorUtil.formatHEX(""));
