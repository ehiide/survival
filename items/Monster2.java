...
public class Monster2
{
    public static ItemStack getItem()
    {
        ...
        potion.setColor(Color.fromRGB(255, 157, 150));
        ...
        lore.add(ColorUtil.formatHEX(" &8> &7Nazwa: &fMonster Ultra Red"));
        lore.add(ColorUtil.formatHEX(" &8> &7Klasyfikacja: &fStymulanty"));
        lore.add(ColorUtil.formatHEX(" &8> &7Zawartosc kofeiny: &f110mg"));
        lore.add(ColorUtil.formatHEX(" &8> &7Rodzina substancji: &fN/A"));
        lore.add(ColorUtil.formatHEX(""));
        lore.add(ColorUtil.formatHEX("   &e&o(Ciekawostka: Monster ten to"));
        lore.add(ColorUtil.formatHEX("   &e&oekskluzywny i rzadki napoj,"));
        lore.add(ColorUtil.formatHEX("   &e&oprzeznaczony dla entuzjastow)"));
        lore.add(ColorUtil.formatHEX(""));
