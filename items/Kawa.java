...
public class Kawa
{
    public static ItemStack getItem()
    {
        ...
        potion.setColor(Color.fromBGR(0, 51, 102));
        ...
        lore.add(ColorUtil.formatHEX(" &8> &7Nazwa: &fKawa"));
        lore.add(ColorUtil.formatHEX(" &8> &7Klasyfikacja: &fStymulanty"));
        lore.add(ColorUtil.formatHEX(" &8> &7Zawartosc kofeiny: &f80mg"));
        lore.add(ColorUtil.formatHEX(" &8> &7Rodzina substancji: &fARA"));
        lore.add(ColorUtil.formatHEX(""));
        lore.add(ColorUtil.formatHEX("   &e&o(Ciekawostka: Kawa nie dziala"));
        lore.add(ColorUtil.formatHEX("   &e&opobudzajaco. Jest to uboczny efekt"));
        lore.add(ColorUtil.formatHEX("   &e&ojej antagonistycznego dzialania"));
        lore.add(ColorUtil.formatHEX("   &e&ona receptory adenozyny)"));
        lore.add(ColorUtil.formatHEX(""));
        ...
        meta.setDisplayName(ChatColor.translateAlternateColorCodes('&', "&fKawa"));
        meta.setLore(lore);
    ...
    {
        NamespacedKey key = new NamespacedKey(Main.getInstance(), "kawa_crafting");
        ShapedRecipe recipe = new ShapedRecipe(key, getItem());

        recipe.shape("AKA", "SBS", "AKA");
