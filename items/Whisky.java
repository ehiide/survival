...
public class Whisky
{
    public static ItemStack getItem()
    {
        ...
        potion.setColor(Color.fromBGR(153, 255, 255));
        ...
        lore.add(ColorUtil.formatHEX(" &8> &7Nazwa: &fWhisky"));
        lore.add(ColorUtil.formatHEX(" &8> &7Klasyfikacja: &fAlkohole"));
        lore.add(ColorUtil.formatHEX(" &8> &7Zawartosc alkoholu: &f32%"));
        ...
        meta.setDisplayName(ChatColor.translateAlternateColorCodes('&', "&fWhisky"));
        meta.setLore(lore);
