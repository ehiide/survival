...
public class Amina
{
    public static ItemStack getItem()
    {
        ...
        lore.add(ColorUtil.formatHEX(" &8> &7Nazwa: &fAmina"));
        ...
        meta.setDisplayName(ChatColor.translateAlternateColorCodes('&', "&bAmina"));
        meta.setLore(lore);
    ...
    {
        NamespacedKey key = new NamespacedKey(Main.getInstance(), "amina_crafting");
        ShapedRecipe recipe = new ShapedRecipe(key, getItem());

        recipe.shape("GGA", "GBW", "AWW");
        recipe.setIngredient('B', Material.BLAZE_POWDER);
        recipe.setIngredient('A', Material.AIR);
        recipe.setIngredient('G', Material.LIGHT_GRAY_DYE);
